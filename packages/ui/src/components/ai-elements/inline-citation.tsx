...
export const InlineCitationSource = ({
  ...
  <div className={cn('space-y-1', className)} {...props}>
    {title ? <h4 className='truncate text-sm/tight font-medium'>{title}</h4> : null}
    {url ? <p className='truncate text-xs break-all text-muted-foreground'>{url}</p> : null}
    {description ? <p className='line-clamp-3 text-sm/relaxed text-muted-foreground'>{description}</p> : null}
    {children}
  </div>
)
