...
export type PromptInputProps = Omit<HTMLAttributes<HTMLFormElement>, 'onError' | 'onSubmit'> & {
  ...
  onSubmit: (message: PromptInputMessage, event: React.SubmitEvent<HTMLFormElement>) => Promise<void> | void
...
export const PromptInputSpeechButton = ({
  ...
  useEffect(() => {
    if (
      ...
      const SpeechRecog = globalThis.window.SpeechRecognition || globalThis.window.webkitSpeechRecognition,
