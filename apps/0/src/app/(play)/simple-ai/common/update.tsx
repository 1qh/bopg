...
import { UpdateSimpleAiSchema } from '@a/db/schema'
import { cn } from '@a/ui'
...
const Update = (defaultValues: typeof UpdateSimpleAiSchema.infer) => {
  const [open, setOpen] = useState(false),
    { simpleAi } = api(),
    form = useForm({
      defaultValues,
      resolver: standardSchemaResolver(UpdateSimpleAiSchema)
    }),
