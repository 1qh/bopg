import type { FlowEdge, FlowNode } from '../../[id]/flowui/types'
...
const FLOW_TEMPLATES: FlowData[] = [
  {
    ava: '01',
    description:
      'Taking an article, creating a summary, checking if the summary matches the original text, and then turning approved summaries into social media posts.',
    edges: [
      {
    ...
    nodes: [
      ...
      {
        data: {
          text: 'You take in as input a news article and summarize it into a very short paragraph.\n'
        },
      ...
      {
        data: {
          text: "You will receive an original article and a summarized version of the article. Your task is to compare the summarized version to the original to see if it contains all the main information, and if it's clear and well-written.\nIf the summary is not valid, you should return the failResponse tool. If the summary is valid, you should return the summary as the validResponse tool. You should ALWAYS! return the summary to either the valid or fail response"
        },
          ...
          tags: [
            {
              ...
              tag: 'summarized-article'
            },
            {
              id: 'EFNnxyTEq05gZOjmUXDpL',
              tag: 'original-article'
            }
          ],
      ...
      {
        data: {
          text: 'You will receive a summary of an article and you are to generate a post for:\n\n- Instagram\n- Twitter'
        },
    ...
    template: 'news-summarization'
  },
  {
    ava: '02',
    description:
      'Three specialized agents: a blog writing expert, a social media content creator, or an SEO specialist. Each expert then processes the request according to their specialty.',
    edges: [
      {
        id: 'xy-edge__validationSystemPromptresult-validateLLMsystem',
        source: 'validationSystemPrompt',
    ...
    nodes: [
      ...
      {
        data: {
          text: 'You are an expert in creating short form content. Your task is to generate creative and well structured short content posts for instagram, twitter and others'
        },
        id: '97RH-yQMOC0ANhS2vFhcO',
        position: {
          x: 755,
      ...
      {
        data: {
          text: 'You are an expert in writing blogs. Your task is to generate creative and well structured blogs, using appropiate sections and subsections'
        },
      ...
      {
        data: {
          text: 'You are an expert in Search Engine Optimization SEO. Your task is to analyze content and provide suggestions on what keywords could be better in order to improve SEO'
        },
      ...
      {
        data: {
          text: 'I want to create a twitter post for launching my new website'
        },
  ...
  },
  {
    ava: '03',
    description:
      'Three different agents: one creates multiple choice questions, another makes short answer questions, and the third develops essay questions. Their work happens in parallel, and then a final agent combines everything into a complete, well-structured exam.',
    edges: [
      {
        id: 'xy-edge___4RcYkPOEDKn-hmGOAvy9result-lu-X2l3QTJj8RBk4fDwGLsystem',
        source: '_4RcYkPOEDKn-hmGOAvy9',
    ...
    nodes: [
      ...
      {
        data: {
          text: 'I want to create a exam on React Flow programming'
        },
        id: 'VGFbBVUjlwdQ2cGhrCv72',
        position: {
          x: -722,
          ...
          tags: [
            {
              ...
              tag: 'multiple-choice-content'
            },
            {
              id: 'llV7g536-dmly98vvpFak',
              tag: 'open-answer-questions-content'
            },
            {
  ...
  },
  {
    ava: '04',
    description:
      'A product manager handles technical feature requests. The manager analyzes if the work needs front-end, back-end, or database development, and assigns tasks accordingly. A senior developer then reviews and combines all the code into a final solution.',
    edges: [
      {
        id: 'xy-edge__validationSystemPromptresult-validateLLMsystem',
        source: 'validationSystemPrompt',
    ...
    nodes: [
      ...
      {
        data: {
          text: "We're adding a feature to let users save their favorite products. The Front-end needs to update the product list UI, the Back-end must handle the logic for saving favorites, and the Database needs to store these preferences."
        },
        id: 'VGFbBVUjlwdQ2cGhrCv72',
        position: {
          x: -707,
      ...
      },
      {
        data: {
          ...
          text: 'Here is the output from the developers\n<frontend>\n  {{frontend-result}}\n</frontend>\n<backend>\n  {{backend-result}}\n</backend>\n<database>\n  {{database-result}}\n</database>'
        },
